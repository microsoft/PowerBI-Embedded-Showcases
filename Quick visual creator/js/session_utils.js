...
function populateEmbedConfigIntoCurrentSession(url, updateCurrentToken) {
    ...
    try {
        let configFromParentWindow = window.parent.showcases.quickVisualCreator;
...
function loadQuickVisualCreatorReportConfigIntoSession() {
    ...
    return populateEmbedConfigIntoCurrentSession(layoutShowcaseReportUrl, false /* updateCurrentToken */);
}
